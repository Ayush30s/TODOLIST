...
const TaskBody = () => {
   ...
   return (
      <div className="bg-blue-50 w-[100vw] h-[100vh] p-5">
         ...
         <div id="taskdiv" className = {
            "mx-[25%] w-[50vw] max-h-[300px] my-5 p-5 h-screen overflow-y-scroll scrollbar-thin scrollbar-thumb-blue-100 scrollbar-track-gray-200 bg-blue-300 border border-blue-400 rounded-lg"
         }>
            {countTask === 0 ? (
                     ...
                     {Object.keys(tasks).map((key) => {
                        ...
                        return (
                           <div className="flex flex-row justify-between" key={key}>
                              <li className="px-2 w-[70%] py-1 text-sm bg-white border border-blue-400 m-1 max-h-[100px] overflow-y-scroll rounded-xl text-black whitespace-normal break-words">{task.text}</li>
